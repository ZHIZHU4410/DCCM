...
namespace PrisonCorruptDepthstest.Levels.DeathArena;

public class DeathArenaLevel : ILevel
{
    public static ModCore.Storage.Config<DeathArenaConfig> Config { get; } = new("DeathArenaConfig");
    ...
    {
        return new DeathArenaLevelStruct(user, levelData, rng);
    }
