...
namespace PrisonCorruptDepthstest.Levels.PrisonCorruptMod;

public class PrisonCorruptModLevel : ILevel
{
    public static ModCore.Storage.Config<PrisonCorruptModConfig> Config { get; } = new("PrisonCorruptModConfig");

    public string LevelId => Config.Value.LevelId;
    public string DisplayName => "腐化牢房";
    public string Biome => "PrisonCorrupt";
    ...
    {
        return new PrisonCorruptModLevelStruct(user, levelData, rng);
    }
