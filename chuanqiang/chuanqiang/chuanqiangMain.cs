...
namespace chuanqiang
{
    public class chuanqiangMain : ModBase, IOnGameExit, IOnHeroUpdate, IOnGameEndInit
    {
        // ---------- 颜色转换辅助方法 ----------
        ...
        public chuanqiangMain(ModInfo info) : base(info) { }
        ...
        public override void Initialize()
        {
            ...
            System.Console.WriteLine("chuanqiangMain 初始化完成");
        }
        ...
        {
            System.Console.WriteLine("游戏退出，chuanqiangMain 资源清理");
        }
    }
}
