...
namespace addshanghai
{
    public class addshanghaiMain : ModBase, IOnHeroUpdate
    {
        private static addshanghaiMain? _instance;
        ...
        public addshanghaiMain(ModInfo info) : base(info)
        {
            _instance = this;
        }
