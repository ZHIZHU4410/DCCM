...
namespace hutao
{
    public class hutaoMain : ModBase, IOnGameExit, IOnHeroUpdate
    {
        // ---------- 关卡深度映射 ----------
        ...
        public hutaoMain(ModInfo info) : base(info) { }
        ...
        public override void Initialize()
        {
            ...
            System.Console.WriteLine("hutaoMain 初始化完成！");
        ...
        private void CreateBoostDisplayText()
        {
            try
            {
                ...
                if (root == null)
                {
                    System.Console.WriteLine("[hutaoMain] 无法获取 UI root，稍后重试");
                    return;
                }
            ...
            {
                System.Console.WriteLine($"[hutaoMain] 创建 UI 文本失败：{ex.Message}");
            }
        }
        ...
        void IOnHeroUpdate.OnHeroUpdate(double dt)
        {
            ...
            if (isF1PressedNow && !_isF1KeyPressed)
            {
                ...
                System.Console.WriteLine($"[hutaoMain] 显示状态切换为: {(_isDisplayEnabled ? "开启" : "关闭")}");
        ...
        void IOnGameExit.OnGameExit()
        {
            ...
            System.Console.WriteLine("游戏退出，hutaoMain 资源清理");
            if (_boostDisplayText != null)
            {
                _boostDisplayText.remove();
                _boostDisplayText = null;
