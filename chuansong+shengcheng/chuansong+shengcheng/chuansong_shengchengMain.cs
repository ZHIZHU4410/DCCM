...
namespace chuansong_shengcheng
{
    public class chuansong_shengchengMain : ModBase, IOnGameExit, IOnHeroUpdate
    {
        // ---------- 关卡深度映射 ----------
        ...
        // ---------- 构造函数 ----------
        public chuansong_shengchengMain(ModInfo info) : base(info)
        {
        }
        ...
        {
            base.Initialize();
            System.Console.WriteLine("✅ chuansong_shengchengMain 初始化完成，按 N 传送上一关，按 M 传送下一关，按 K 切换方向反转");
        }
        ...
        {
            System.Console.WriteLine("游戏退出，chuansong_shengchengMain 资源清理");
        }
    }
}
